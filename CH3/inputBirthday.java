/*
 *  Write a method called inputBirthday that accepts a Scanner for the console as a parameter and prompts 
 *  the user to enter a month, day, and year of birth, then prints the birthdate in a suitable format. 
 ...
 */
 ...
 public static void inputBirthday(Scanner scan){   
    ...
    System.out.println("You were born on " + monthName + " " + month +", " + year + ". You're mighty old!");
}
