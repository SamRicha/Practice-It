 ...
 *  the first and last characters are "x"; on the second line, the second and second-from-last characters 
 *  are "x"; and so on. If 0 or less is passed for the size, no output should be produced.
 *  
