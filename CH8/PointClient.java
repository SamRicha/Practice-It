 ...
 *  The expected output is shown below. Finish the program so that it runs properly.
 *  
 *  p1 is (8, 2)
 *  p2 is (4, 3)
...
        System.out.println("p1's distance from origin is " + (p1.distance(p2) + p1.distance(p2)));
